    ...
    <View style={styles.container}>
      ...
      <NavBar />
        ...
        <View>
          ...
          <View style={styles.tabContainer}>
            <TouchableOpacity style={[styles.tabButton, { backgroundColor: activeTab === 'mangas' ? '#F9A8D4' : '#9D9D9D', elevation: activeTab === 'mangas' ? 20 : 0, width: activeTab === 'mangas' ? '60%' : '60%', marginLeft: activeTab === 'mangas' ? '-5%' : '20%', marginRight: activeTab === 'mangas' ? '-5%' : '20%', zIndex: activeTab === 'mangas' ? 1 : 0 }]} onPress={switchToMangaTab}>
              <Text style={[styles.tabButtonText, { color: activeTab === 'mangas' ? 'white' : 'black' }]}>Manga</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.tabButton, { backgroundColor: activeTab === 'chapters' ? '#F9A8D4' : '#9D9D9D', elevation: activeTab === 'chapters' ? 10 : 0, width: activeTab === 'chapters' ? '60%' : '60%', marginLeft: activeTab === 'chapters' ? '-5%' : '20%', marginRight: activeTab === 'chapters' ? '-5%' : '10%', zIndex: activeTab === 'chapters' ? 1 : 0 }]} onPress={switchToChaptersTab}>
      ...
      {activeTab === 'chapters' && (
        <View>
            <ScrollView>
              <View style={styles.tabContainer}>
                <TouchableOpacity style={[styles.tabButton, { backgroundColor: activeTab === 'mangas' ? '#F9A8D4' : '#9D9D9D', elevation: activeTab === 'mangas' ? 20 : 0, width: activeTab === 'mangas' ? '60%' : '60%', marginLeft: activeTab === 'mangas' ? '-5%' : '20%', marginRight: activeTab === 'mangas' ? '-5%' : '10%', zIndex: activeTab === 'mangas' ? 1 : 0 }]} onPress={switchToMangaTab}>
                  <Text style={[styles.tabButtonText, { color: activeTab === 'mangas' ? 'white' : 'black' }]}>Manga</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.tabButton, { backgroundColor: activeTab === 'chapters' ? '#F9A8D4' : '#9D9D9D', elevation: activeTab === 'chapters' ? 10 : 0, width: activeTab === 'chapters' ? '60%' : '60%', marginLeft: activeTab === 'chapters' ? '-5%' : '20%', marginRight: activeTab === 'chapters' ? '-5%' : '18%', zIndex: activeTab === 'chapters' ? 1 : 0 }]} onPress={switchToChaptersTab}>
                  <Text style={[styles.tabButtonText, { color: activeTab === 'chapters' ? 'white' : 'black' }]}>Chapters</Text>
                </TouchableOpacity>
              </View>
          ...
          <View style={styles.paginationContainer}>
            <TouchableOpacity style={[styles.paginationButton, { backgroundColor: prev ? '#FF97DB' : '#9D9D9D' }]} onPress={handlePrevPage}>
              <Text style={styles.paginationButtonText}>Prev</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.paginationButton, { backgroundColor: next ? '#FF97DB' : '#9D9D9D' }]} onPress={handleNextPage}>
